...
public class Jdbcs {
	...
	public static JdbcOptionsInWrite options(String uri, String table) {
		return options(uri, table, null, null, null);
	}

	public static JdbcOptionsInWrite options(Iterable<String> cols, String opt) {
		return options(null, null, null, cols, opt);
	}

	public static JdbcOptionsInWrite options(String uri, String table, String... cols) {
		return options(uri, table, null, Arrays.asList(cols), null);
	}

	public static JdbcOptionsInWrite optionsWithKeys(String uri, String table, String keys, String... cols) {
		return options(uri, table, keys, Arrays.asList(cols), null);
	}

	@SuppressWarnings("unchecked")
	public static JdbcOptionsInWrite options(String uri, String table, String keys, Iterable<String> cols, String opt) {
		...
		if (!Strings.isNullOrEmpty(keys)) {
			props.put("createTableKeys", keys);
		}
		...
		// return new JdbcOptionsInWrite((scala.collection.immutable.Map<String, String>) tuple2Seq.apply(Map$.MODULE$));
	}
